...
\usepackage{tikz}
\usepackage{pgfplots}
\usetikzlibrary{patterns,patterns.meta,arrows.meta,positioning,decorations.pathreplacing,decorations.text,shapes.geometric}
...
\newfontfamily\verbatimfont{TeX Gyre Cursor}[FakeBold=0.25]
...
% Slightly thicken only verbatim blocks without affecting inline \texttt.
\makeatletter
\def\verbatim@font{\normalfont\verbatimfont}
\makeatother
